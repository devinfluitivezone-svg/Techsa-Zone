              ...
              <div className="row align-items-center">
                <div className="col-lg-7">
                  <div className="main-banner-content">
                    ...
                    <p>
                      Discover the power of strategic digital marketing that drives real results. Our comprehensive approach combines SEO expertise, social media mastery, and data-driven insights to elevate your brand above the competition and achieve sustainable business growth.
                    </p>
